...
<head>
    ...
    <title>VisionEA - Authentication</title>
            ...
            $("#login").click(function(){
                ...
                if ($isValid){
                    ...
                    function(data, status){
                        ...
                        }else if (data == "renewonly"){
                            location.href = "./?MNav=renewPac";
                        }else {
...
<body onLoad="document.getElementById('id01').style.display='block'">
    <div id="id01" class="modal">
        <form class="modal-content animate" action="login.php" method="post" onSubmit="return false;">
            <div class="imgcontainer">
                <!-- <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span> -->
                <!-- <img src="..\images\<?php echo $COMPANY_LOGO ?>" alt="Avatar" class="avatar"></div> -->
                <img src="..\images\<?php echo $COMPANY_LOGO ?>" alt="Avatar" ></div>
                <div class="container">

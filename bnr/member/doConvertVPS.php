...
if (!empty($_POST)) { 
  ...
  //Validation inputs
    ...
    if ($username == $transferTo){ //must the same username, because convert on they own account
      //cek wallet
      if ($wallet >= $amountVoucher && $wallet >= $voucherPrice){
        ...
        if (!fCheckSecurityPassword($username, $secPasswd, $conn)){
          ...
          $sql = "SELECT COUNT(*) AS ttlVoucher FROM dtVoucher WHERE vStatus = '". $DEF_STATUS_ACTIVE ."' AND vType='". $DEF_VOUCHER_TYPE_VPS ."'";
          ...
          if ($row["ttlVoucher"] < $numberOfVoucher){
            ...
            $curs     = "1";
            $accName  = "";
            $accType  = $DEF_CONVERT_WALLET_VOUCHER;
            ...
            14 => array ("db" => "finDesc"   , "val" => "CONVERT WALLET")
            );
            ...
            if (fInsert($table, $arrData, $conn)){
              //insert success
              $sql = "SELECT vID, vCode FROM dtVoucher WHERE vStatus='" . $DEF_STATUS_ACTIVE . "' AND vType='". $DEF_VOUCHER_TYPE_VPS ."'";
              $query = $conn->query($sql);
              $counter = 0;
              while ($row = $query->fetch_assoc()){ 
                if ($counter < $numberOfVoucher){
                  ...
                  $arrData = array(
                        ...
                        array("db" => "fivType", "val"  => $DEF_VOUCHER_TYPE_VPS),
            ...
            if ($isFailed==false){
              ...
              header("Location: ".$COMPANY_SITE. "member/doConvertVPS.php?q=info-success");
              die();
            }
          }
        }
      }else{
        $responseMessage .= "Your wallet balance is not enough<br>";  
      }
    }else{
...
<div class="card">
    <div class="card-header card-header-success card-header-icon">
        <div class="card-icon">
		 ...
		 <div class="card-text">
           <h4 class="card-title">Convert Wallet</h4>
        </div>
    </div>
                        ...
                        <div class="tab-content tab-space">
                            <div class="tab-pane active" id="linkConvert">
                                <?php if ($responseMessage != ""){ ?>
                                 ...
                                 <div class="row">
                                    <div class="col-md-8" >
                                      <form method="post" action="doConvertVPS.php">
                                          <div class="row">
                                              <label class="col-md-4 text-left text-vCenter">Wallet Balance</label>
                                              <div class="col-md-8">
                                                  <div class="form-group has-default">
                                                      <input type="text" name="wallet" id="wallet" value="<?php echo $wallet; ?>" class="form-control" title="Wallet Balance" readonly  style="background: transparent; border-bottom: solid; border-bottom-width: 1px ">
                                                  </div>
                                              </div>
                                          </div>
                                          <div class="row">
                                              ...
                                              <div class="col-md-8">
                                                  <div class="form-group has-default">
                                                      ...
                                                      <input type="number" step="<?php echo $voucherPrice; ?>" name="amountVoucher" id="amountVoucher" value="<?php echo $amountVoucher; ?>"  class="form-control" title="Amount of PIN to transfer to others" required>
                                                  </div>
                                              </div>
                                          </div>
                                          <div class="row">
                            ...
                            <?php 
                              ...
                              */
                              ...
                              $sql .= "   WHERE finMbrUsername='". $_SESSION['sUserName'] ."' AND finAccType='" . $DEF_CONVERT_WALLET_VOUCHER . "'  ";
                                  ...
                                  <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                      ...
                                      <tbody>
                                          ...
                                          <tr>
                                              ...
                                              <td><?php echo "Wallet " . $rowHistory["sender"] ." - ".$rowHistory["receiver"] ?></td>
                                              <td><?php 

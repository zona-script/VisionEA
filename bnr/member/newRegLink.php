...
if (!empty($_POST)) { 
	...
	// echo "<br> $country || $package || $username || $name || $IDType || $IDN || $BOD || $sponsorUsername || $sponsorName || $password || $rePassword || $mblCountryCode || $mobile || $codeMobile || $email || $state || $city || $address || $agree || $code || $secureCodeMessage "; die();
			...
			if ($code != $_SESSION["code"]){
				...
				if ($query->num_rows == 0){
					...
					if ($query->num_rows > 0){
						...
						//send notif to admin
						//fSendToAdmin('REGISTER_FAILED_USER_DUPLICATE', 'newRegLink.php', 'username duplicate: ' . $username);
					}else {
						if (fInsert("dtTempJoin", $arrData, $conn)){
							...
							if (!fSendNotifToEmail("REGISTER_SUCCESS", $username)){
								//fail sending email
								fSendToAdmin('REGISTER_NEW_MEMBER', 'newRegLink.php', 'send email failed');
							}
							//fSendToAdmin('REGISTER_NEW_MEMBER', 'newRegLink.php', 'send success');
							//redirect to success page
							header("Location: newRegLink.php?q=info-success");
							die();
						}else{
							//insert fail	
							...
							//send notif to admin
							fSendToAdmin('REGISTER_NEW_MEMBER', 'newRegLink.php', 'sql: insert failed');
						} // end else
...
<div class="card">
    ...
    <div class="card-body card-fix">
        <div class="content">
            ...
            <form action="newRegLink.php" method="post">
                	...
                	<div class="col-md-6">
                        ...
                        <div class="row">
                        	...
                        	<div class="form-group col-md-4">
                                <input id="sponsorUsername" name="sponsorUsername" type="text" value="<?php echo $sponsorUsername; ?>" class="form-control" required>
                        ...
                        <div class="row">
	                        ...
	                        <div class="form-group col-md-9">
                                 <input id="username" name="username" type="text" title="Username" class="form-control" maxlength='15' required>
                        ...
                        <div class="row">
	                        ...
	                        <div class="form-group col-md-9">
    	                         <input id="IDN" name="IDN" type="text"  class="form-control" required>
                        ...
                        <div class="row">
                         ...
                         <div class="row">
 	                        ...
 	                        <div class="form-group col-sm-9">
                                 <input id="password" name="password" type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,12}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 6 and max 12 characters" class="form-control" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                <input type="text" id="codeMobile" class="form-control" style="background:none" name="codeMobile" readonly>
                            </div>
                            <div class="form-group col-md-5">
                        ...
                        <div class="row">
	                        ...
	                        <div class="form-group col-md-9">
                             <input id="email" name="email" type="email" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required>
                            </div>
                        </div>
                        <!--
                         <div class="col-md-12">
